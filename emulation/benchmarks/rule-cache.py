...
def continuous_retrain(args):
    ...
    # use_rule_cache_every_x_windows = 4
    use_rule_cache_every_x_windows = args.rule_cache_frequency
    ...
    for k, (features, gt_label, raw_features, generated_label) in enumerate(streaming_dataloader):
        ...
        # ====================================================================
            ...
            if args.labeler_type == "DNN_classifier":
                ...
                my_model_f1s_proxy.append(my_window_f1_proxy.cpu().item())
                static_model_f1s_proxy.append(static_window_f1_proxy.cpu().item())
            ...
            if args.labeler_type == "LLM" and \
                ...
                # generate rule function for the labeling rule cache
                if enable_rule_cache:

                    compute_rules_function_input = torch.cat((online_learning_raw_features, \
                                                                valid_labels.unsqueeze(1)), 1)

                    # TODO: move error handling for function generation into the labeler class
                    while True:
                        ...
                        try:
                            exec(rule_cache_function_def)
                            break
                        except:
                            print("the generated rule function is invalid, try to regenerate...")
                            continue
    ...
    result_json = {
        ...
        "rule_cache_frequency": args.rule_cache_frequency,
        ...
        "tokens_cost": llm_total_tokens,
        "dollar_cost": llm_total_dollars,
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=int,
        help="Generate new rules for rule cache every X windows",
        default=10,
    )
