...
def run_experiment():
    ...
    # this runs the experiment associated with figure 7        
    subprocess.run(
        [
            "python3",
            ...
            # Output File
            "-o",
            f"{caravan_home}/emulation/scripts/results/figure7-experiment.jsonl",

            # Logging Directory
            "--logdir",
            f"{caravan_home}/emulation/logs/figure7",
