...
def run_experiment():
    ...
    # this runs the experiment associated with figure 4(a)
    for labeling_window_size in labeling_window_sizes:
        ...
        subprocess.run(
            [
                ...
                # Output File
                "-o",
                f"{caravan_home}/emulation/scripts/results/figure4a-experiment.jsonl",

                # Logging Directory
                "--logdir",
                f"{caravan_home}/emulation/logs/figure4a",
