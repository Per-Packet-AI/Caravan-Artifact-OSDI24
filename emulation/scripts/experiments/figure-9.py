...
def run_experiment():
    ...
    retrain_every_x_windows_params = [5, 10, 20, 40]

    for retrain_every_x_windows in retrain_every_x_windows_params:

        # this runs the experiment associated with figure 9
        subprocess.run(
            [
                "python3",
                f"{caravan_home}/emulation/benchmarks/retraining-trigger.py",
                ...
                "-i",
                f"{caravan_home}/emulation/datasets/cic-ids2017-workload2.csv",

                # Output File
                "-o",
                f"{caravan_home}/emulation/scripts/results/figure9-experiment.jsonl",

                # Logging Directory
                "--logdir",
                f"{caravan_home}/emulation/logs/figure9",
