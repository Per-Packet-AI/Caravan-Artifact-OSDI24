...
with open(f'{caravan_home}/emulation/scripts/results/figure10c-experiment.jsonl', 'r') as result_file:
...
# Plotting the lines
plt.figure()
plt.plot(caravan_gpu_cycle, caravan_accuracy_gain, marker='o', linewidth=3, markersize=10, label='Caravan', color=colors[0])
plt.plot(cts_training_gpu_cycle, cts_training_accuracy_gain, marker='o', linewidth=3, markersize=10, label='Continuous retraining w/ generated labels', color=colors[2])
plt.plot(oracle_gpu_cycle, oracle_accuracy_gain, marker='o', linewidth=3, markersize=10, label='Continuous retraining', color=colors[1])
...
# t = plt.text(20.0, 0.1, "Better", ha="right", va="bottom", rotation=-45,
...
plt.savefig(f"{caravan_home}/emulation/scripts/figures/figure-10c.png")