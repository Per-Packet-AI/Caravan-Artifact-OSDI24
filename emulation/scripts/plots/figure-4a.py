...
with open(f'{caravan_home}/emulation/scripts/results/figure4a-experiment.jsonl', 'r') as result_file:
...
rects1 = ax.bar(index - 0.5 * bar_width, generated_labels_improvements, bar_width, label='Retraining with DNN-generated labels', color=colors[0])
